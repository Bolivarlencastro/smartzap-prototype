...
describe('AdminAccessGuard', () => {
  ...
  it('should not activate the route when the user is not an admin', (doneFn) => {
  ...
  it('should not activate the route children when the user is not an admin', (doneFn) => {
    userProfileSpy.getApplicationRoles.mockReturnValue(['basic_analytics_user']);
  ...
  it('should not load the route when the user is not an admin', (doneFn) => {
    userProfileSpy.getApplicationRoles.mockReturnValue(['basic_analytics_user']);
