...
import { ClassHtmlComponent } from './html.component';
...
describe('ClassHtmlComponent', () => {
  let component: ClassHtmlComponent;
  let fixture: ComponentFixture<ClassHtmlComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [ClassHtmlComponent],
      providers: [{ provide: ClassroomFacade, useValue: classroomFacadeMock }],
      schemas: [CUSTOM_ELEMENTS_SCHEMA],
    }).compileComponents();

    fixture = TestBed.createComponent(ClassHtmlComponent);
  ...
  it('should clear the tracker and initialize it after the default LOADING_DELAY when the content changes', () => {
    ...
    contentSubject.next({ url: contentUrl, content_type: { name: 'HTML' } } as LearnContent);
